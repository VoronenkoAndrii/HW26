...
public class WizzairTest {
    ...
    public void ticketSearchTest(){
        ...
        $(".flight-search__panel__cta-btn base-button").click();
        ...
        $$x("//time[@data-test='flight-select-flight-into-deteils-time']").get(0).shouldHave(Condition.text(" Fri, 18 Jun 2021 "));
        $$x("//time[@data-test='flight-select-flight-into-deteils-time']").get(1).shouldHave(Condition.text(" Fri, 25 Jun 2021 "));
        $x("//aside//div[@data-test='search-change__details__passenger']").shouldHave(Condition.text(" 2 Passengers "));
    }
}
